...
| cache | [Microsoft.Extensions.Caching.Memory.IMemoryCache](#T-Microsoft-Extensions-Caching-Memory-IMemoryCache 'Microsoft.Extensions.Caching.Memory.IMemoryCache') | A memory cache to be used to cache resolved schemas if desired |
