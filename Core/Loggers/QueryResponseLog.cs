...
namespace MQContract.Loggers
{
    ...
    internal static partial class QueryResponseLog
    {
        ...
        [LoggerMessage(
            EventId = 3016,
            Level = LogLevel.Information,
            Message = "Attempting a QueryResponse call using PubSub style messaging, querying {TQuery}, expecting a response of {TQueryResponse} on {ResponseChannel}"
            )]
        ...
        [LoggerMessage(
            EventId = 3017,
            Level = LogLevel.Debug,
            Message = "QueryResponse reply channel mapped to {ReplyChannel}"
            )]
        ...
        [LoggerMessage(
            EventId = 3018,
            Level = LogLevel.Debug,
            Message = "Starting Response listener for Query over PubSub waiting on a message with {CallID}"
            )]
        ...
        [LoggerMessage(
            EventId = 3019,
            Level = LogLevel.Debug,
            Message = "Transmitting Query request over PubSub"
            )]
        ...
        [LoggerMessage(
            EventId = 3020,
            Level = LogLevel.Debug,
            Message = "PubSub Query tranmission failed cleaning up resources"
            )]
        ...
        [LoggerMessage(
            EventId = 3021,
            Level = LogLevel.Debug,
            Message = "Waiting on Query Response over PubSub"
            )]
        ...
        [LoggerMessage(
            EventId = 3022,
            Level = LogLevel.Debug,
            Message = "Query Response over PubSub recieved"
            )]
