...
namespace MQContract.Connections
{
    internal static class OtelHelper
    {
        ...
        private const string ConnectionNameKey = $"{OpenTelemetryMiddleware.KeyBase}.connectionname";
        ...
        public static void AddMessagePublishedEvent(Activity? activity, ServiceMessage serviceMessage, TransmissionResult result, IMessageServiceConnection serviceConnection, string connectionName = "DEFAULT")
