...
namespace CoreTesting.ConnectionTests.Consumers
{
    ...
    public class QueryResponseAsyncConsumerTests
    {
        ...
        public async ValueTask CheckDefaultRegistrationUsingGenericsAndSuppliedInstance()
        {
            ...
            #region Act
            contractConnection = await contractConnection.RegisterQueryResponseAsyncConsumerAsync<BasicQueryMessage, BasicResponseMessage, IQueryResponseAsyncConsumer<BasicQueryMessage, BasicResponseMessage>>(mockAsyncConsumer.Object, cancellationToken: TestContext.CancellationToken);
        ...
        public async ValueTask CheckRegistrationUsingGenericsAndSuppliedInstanceWithParameters(string? channel, string? group)
        {
            ...
            #region Act
            _ = await contractConnection.RegisterQueryResponseAsyncConsumerAsync<BasicQueryMessage, BasicResponseMessage, IQueryResponseAsyncConsumer<BasicQueryMessage, BasicResponseMessage>>(mockAsyncConsumer.Object, channel: mappedChannel, group: mappedGroup, cancellationToken: TestContext.CancellationToken);
            #endregion
        ...
        public async ValueTask CheckDefaultRegistrationUsingGenericsWithoutInstance()
        {
            ...
            #region Act
            contractConnection = await contractConnection.RegisterQueryResponseAsyncConsumerAsync<BasicQueryMessage, BasicResponseMessage, BasicQueryAsyncConsumer>(cancellationToken: TestContext.CancellationToken);
            #endregion
            ...
            Assert.HasCount(1, groups);
            Assert.HasCount(1, errorActions);
            Assert.AreEqual(typeof(BasicQueryAsyncConsumer).GetCustomAttribute<ConsumerAttribute>(false)!.Channel!, channels[0]);
            Assert.AreEqual(typeof(BasicQueryAsyncConsumer).GetCustomAttribute<ConsumerAttribute>(false)!.Group!, groups[0]);
            #endregion
        ...
        public async ValueTask CheckRegistrationUsingGenericsWithoutInstanceWithParameters(string channel, string group)
        {
            ...
            #region Act
            _ = await contractConnection.RegisterQueryResponseAsyncConsumerAsync<BasicQueryMessage, BasicResponseMessage, BasicQueryAsyncConsumer>(channel: mappedChannel, group: mappedGroup, cancellationToken: TestContext.CancellationToken);
            #endregion
            ...
            #region Verify
            serviceConnection.Verify(x => x.SubscribeQueryAsync(It.IsAny<Func<ReceivedServiceMessage, ValueTask<ServiceMessage?>>>(), It.IsAny<Action<Exception>>(),
                mappedChannel??typeof(BasicQueryAsyncConsumer).GetCustomAttribute<ConsumerAttribute>(false)!.Channel!,
                mappedGroup??typeof(BasicQueryAsyncConsumer).GetCustomAttribute<ConsumerAttribute>(false)!.Group!,
                It.IsAny<CancellationToken>()), Times.Once);
            #endregion
        }
        ...
        public async ValueTask CheckDefaultRegistrationUsingType()
        {
            ...
            #region Act
            _ = await contractConnection.RegisterQueryResponseAsyncConsumerAsync(typeof(BasicQueryAsyncConsumer), cancellationToken: TestContext.CancellationToken);
            #endregion
        ...
        public async ValueTask CheckRegistrationUsingTypeWithParameters(string channel, string group)
        {
            ...
            #region Act
            _ = await contractConnection.RegisterQueryResponseAsyncConsumerAsync(typeof(BasicQueryAsyncConsumer), channel: mappedChannel, group: mappedGroup, cancellationToken: TestContext.CancellationToken);
            #endregion
        ...
        public async ValueTask CheckRegistrationUsingTypeWithInvalidType()
        {
            ...
            #region Act
            var error = await Assert.ThrowsAsync<InvalidConsumerTypeException>(async () => await contractConnection.RegisterQueryResponseAsyncConsumerAsync(typeof(QueryResponseAsyncConsumerTests), cancellationToken: TestContext.CancellationToken));
            #endregion
        ...
        public async ValueTask CheckDefaultRegistrationUsingGenericsAndSuppliedInstanceWithTelemetryData(bool withLinking)
        {
            ...
            serviceConnection.Setup(x => x.SubscribeQueryAsync(
                ...
                Capture.In(groups), It.IsAny<CancellationToken>()))
                .ReturnsAsync(serviceSubscription.Object);
            serviceConnection.Setup(x => x.QueryAsync(Capture.In<ServiceMessage>(publishedMessages), It.IsAny<TimeSpan>(), It.IsAny<CancellationToken>()))
                .Returns(async (ServiceMessage message, TimeSpan timeout, CancellationToken cancellationToken) =>
                {
                    var rmessage = Helper.ProduceReceivedServiceMessage(message, acknowledge: () =>
                    {
            ...
            ConnectionHelper.ValidateConsumeActivity<BasicQueryMessage>(
                ...
                mockAsyncConsumer.Object.GetType(),
                true,
                withLinking
            );
            ...
            string messageValue, string messageCheckValue, bool acknowledgeDrop)
        {
            ...
            #region Act
            contractConnection = await contractConnection.RegisterQueryResponseAsyncConsumerAsync<BasicQueryMessage, BasicResponseMessage, IQueryResponseAsyncConsumer<BasicQueryMessage, BasicResponseMessage>>(mockConsumer.Object, cancellationToken: TestContext.CancellationToken);
            QueryResult<object>? result = null;
            Exception? error = null;
            var messageHeader = new MessageHeader([
                new KeyValuePair<string,string?>(headerKey,headerValue),
