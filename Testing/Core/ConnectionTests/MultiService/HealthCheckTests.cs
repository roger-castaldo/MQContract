...
namespace CoreTesting.ConnectionTests.MultiService
{
    ...
    public class HealthCheckTests
    {
        ...
        public async Task TestValidHealthCheckMultiplePingableServices()
        {
            ...
            contractConnection.RegisterServiceConnection(ServiceName, serviceConnection.Object);
            contractConnection.RegisterServiceConnection((props) => true, $"{ServiceName}2", serviceConnection.Object);
            #endregion
        ...
        public async Task TestDegradedHealthCheckMultiplePingableServices()
        {
            ...
            contractConnection.RegisterServiceConnection(ServiceName, serviceConnection.Object);
            contractConnection.RegisterServiceConnection($"{ServiceName}2", serviceConnection2.Object);
            #endregion
