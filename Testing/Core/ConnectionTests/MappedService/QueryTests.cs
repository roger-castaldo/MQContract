...
, cancellationToken: TestContext.CancellationToken));
        ...
        public async Task TestQueryAsyncWithTooManyConnectionsError()
        {
            ...
            #region Act
            var error = await Assert.ThrowsExactlyAsync<TooManyConnectionMatchesException>(async () => await contractConnection.QueryAsync<BasicQueryMessage, BasicResponseMessage>(testMessage, cancellationToken: TestContext.CancellationToken));
            #endregion
        ...
        public async Task TestQueryAsyncWithNoConnectionMatch()
        {
            ...
            #region Act
            var error = await Assert.ThrowsExactlyAsync<NoConnectionMatchException>(async () => await contractConnection.QueryAsync<BasicQueryMessage, BasicResponseMessage>(testMessage, cancellationToken: TestContext.CancellationToken));
            #endregion
