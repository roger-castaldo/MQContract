...
namespace MQContract.Interfaces
{
        ...
        where TContractConnection : IBaseContractConnection
    {
        ...
        TContractConnection RegisterMiddleware<TMiddleware>()
        ...
        /// <returns>The Contract Connection instance to allow chaining calls</returns>
        TContractConnection RegisterMiddleware(Type middleware);
        /// <summary>
        ...
        /// <returns>The Contract Connection instance to allow chaining calls</returns>
        TContractConnection RegisterMiddleware(IMiddleware instance);
        /// <summary>
        /// Register a middleware of a given type T to be used by the contract connection
        /// </summary>
        ...
        /// <typeparam name="TMiddleware">The type of middle ware to register, it must implement IBeforeDecodeMiddleware or IBeforeEncodeMiddleware or IAfterDecodeMiddleware or IAfterEncodeMiddleware</typeparam>
        /// <returns>The Contract Connection instance to allow chaining calls</returns>
        TContractConnection RegisterMiddleware<TMiddleware>(Func<TMiddleware> constructInstance)
            where TMiddleware : IMiddleware;
        /// <summary>
        ...
        /// <returns>The Contract Connection instance to allow chaining calls</returns>
        TContractConnection RegisterMiddleware(Func<IMiddleware> constructInstance);
        /// <summary>
        /// Register a middleware of a given type T to be used by the contract connection
        /// </summary>
        ...
        /// <returns>The Contract Connection instance to allow chaining calls</returns>
        TContractConnection RegisterMiddleware<TMessage>(Func<ISpecificTypeMiddleware<TMessage>> constructInstance);
        /// <summary>
        /// Register a middleware of a given type T to be used by the contract connection
        /// </summary>
        ...
        /// <typeparam name="TMessage">The message type that this middleware is specifically called for</typeparam>
        /// <returns>The Contract Connection instance to allow chaining calls</returns>
        TContractConnection RegisterMiddleware<TMessage>(ISpecificTypeMiddleware<TMessage> instance);
        /// <summary>
        /// Register a middleware of a given type T to be used by the contract connection
        /// </summary>
        ...
        /// <typeparam name="TMessage">The message type that this middleware is specifically called for</typeparam>
        /// <returns>The Contract Connection instance to allow chaining calls</returns>
        TContractConnection RegisterMiddleware<TMiddleware, TMessage>()
        ...
        /// <typeparam name="TMessage">The message type that this middleware is specifically called for</typeparam>
        /// <returns>The Contract Connection instance to allow chaining calls</returns>
        TContractConnection RegisterMiddleware<TMiddleware, TMessage>(Func<TMiddleware> constructInstance)
            where TMiddleware : ISpecificTypeMiddleware<TMessage>;
    }
}
