...
namespace MQContract.Interfaces
{
    ...
    /// </summary>
    public interface IConsumerContractConnection<CC> : IBaseContractConnection
        where CC : IBaseContractConnection
    {
        ...
        /// <returns>A boolean indicating success or failure</returns>
        /// <param name="cancellationToken">A cancellation token</param>
        ValueTask<CC> RegisterPubSubConsumerAsync<T, TConsumer>(TConsumer consumer, string? channel = null, string? group = null, bool ignoreMessageHeader = false, MessageFilters<T>? messageFilters = null, CancellationToken cancellationToken = new CancellationToken())
        ...
        /// <returns>A boolean indicating success or failure</returns>
        /// <param name="cancellationToken">A cancellation token</param>
        ValueTask<CC> RegisterPubSubConsumerAsync<T, TConsumer>(string? channel = null, string? group = null, bool ignoreMessageHeader = false, MessageFilters<T>? messageFilters = null, CancellationToken cancellationToken = new CancellationToken())
            where TConsumer : IPubSubConsumer<T>;
        /// <summary>
        /// Called to register a PubSubConsumer into the contract connection. 
        /// </summary>
        ...
        /// <returns>A boolean indicating success or failure</returns>
        /// <param name="cancellationToken">A cancellation token</param>
        ValueTask<CC> RegisterPubSubConsumerAsync(Type consumerType, string? channel = null, string? group = null, bool ignoreMessageHeader = false, CancellationToken cancellationToken = new CancellationToken());
        /// <summary>
        ...
        /// <returns>A boolean indicating success or failure</returns>
        /// <param name="cancellationToken">A cancellation token</param>
        ValueTask<CC> RegisterPubSubAsyncConsumerAsync<T, TConsumer>(TConsumer consumer, string? channel = null, string? group = null, bool ignoreMessageHeader = false, MessageFilters<T>? messageFilters = null, CancellationToken cancellationToken = new CancellationToken())
        ...
        /// <returns>A boolean indicating success or failure</returns>
        /// <param name="cancellationToken">A cancellation token</param>
        ValueTask<CC> RegisterPubSubAsyncConsumerAsync<T, TConsumer>(string? channel = null, string? group = null, bool ignoreMessageHeader = false, MessageFilters<T>? messageFilters = null, CancellationToken cancellationToken = new CancellationToken())
            where TConsumer : IPubSubAsyncConsumer<T>;
        /// <summary>
        /// Called to register a PubSubAsyncConsumer into the contract connection. 
        /// </summary>
        ...
        /// <returns>A boolean indicating success or failure</returns>
        /// 
        ValueTask<CC> RegisterPubSubAsyncConsumerAsync(Type consumerType, string? channel = null, string? group = null, bool ignoreMessageHeader = false, CancellationToken cancellationToken = new CancellationToken());
        /// <summary>
        ...
        /// <param name="cancellationToken">A cancellation token</param>
        /// <returns>A boolean indicating success or failure</returns>
        ValueTask<CC> RegisterQueryResponseConsumerAsync<Q, R, TConsumer>(TConsumer consumer, string? channel = null, string? group = null, bool ignoreMessageHeader = false, CancellationToken cancellationToken = new CancellationToken())
        ...
        /// <param name="cancellationToken">A cancellation token</param>
        /// <returns>A boolean indicating success or failure</returns>
        ValueTask<CC> RegisterQueryResponseConsumerAsync<Q, R, TConsumer>(string? channel = null, string? group = null, bool ignoreMessageHeader = false, CancellationToken cancellationToken = new CancellationToken())
            where TConsumer : IQueryResponseConsumer<Q, R>;
        /// <summary>
        /// Called to register a QueryResponseConsumer into the contract connection. 
        /// </summary>
        ...
        /// <param name="cancellationToken">A cancellation token</param>
        /// <returns>A boolean indicating success or failure</returns>
        ValueTask<CC> RegisterQueryResponseConsumerAsync(Type consumerType, string? channel = null, string? group = null, bool ignoreMessageHeader = false, CancellationToken cancellationToken = new CancellationToken());
        /// <summary>
        ...
        /// <param name="cancellationToken">A cancellation token</param>
        /// <returns>A boolean indicating success or failure</returns>
        ValueTask<CC> RegisterQueryResponseAsyncConsumerAsync<Q, R, TConsumer>(TConsumer consumer, string? channel = null, string? group = null, bool ignoreMessageHeader = false, CancellationToken cancellationToken = new CancellationToken())
        ...
        /// <param name="cancellationToken">A cancellation token</param>
        /// <returns>A boolean indicating success or failure</returns>
        ValueTask<CC> RegisterQueryResponseAsyncConsumerAsync<Q, R, TConsumer>(string? channel = null, string? group = null, bool ignoreMessageHeader = false, CancellationToken cancellationToken = new CancellationToken())
            where TConsumer : IQueryResponseAsyncConsumer<Q, R>;
        /// <summary>
        /// Called to register a QueryResponseAsyncConsumer into the contract connection. 
        /// </summary>
        ...
        /// <param name="cancellationToken">A cancellation token</param>
        /// <returns>A boolean indicating success or failure</returns>
        ValueTask<CC> RegisterQueryResponseAsyncConsumerAsync(Type consumerType, string? channel = null, string? group = null, bool ignoreMessageHeader = false, CancellationToken cancellationToken = new CancellationToken());
    }
}
