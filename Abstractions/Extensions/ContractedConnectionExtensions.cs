...
/// </summary>
public static class ContractedConnectionExtensions
{
    ...
    public static async ValueTask<IContractedConnection> RegisterPubSubConsumerAsync<TMessage, TConsumer>(
        this ValueTask<IContractedConnection> connectionTask,
        TConsumer consumer,
        string? channel = null,
        string? group = null,
    ...
    /// <param name="cancellationToken">A cancellation token</param>
    /// <returns>The Contract Connection instance to allow chaining calls</returns>
    public static async ValueTask<IContractedConnection> RegisterPubSubConsumerAsync(
        this ValueTask<IContractedConnection> connectionTask,
        Type consumerType,
        string? channel = null,
        string? group = null,
    ...
    /// <param name="cancellationToken">A cancellation token</param>
    /// <returns>The Contract Connection instance to allow chaining calls</returns>
    public static async ValueTask<IContractedConnection> RegisterPubSubAsyncConsumerAsync<TMessage, TConsumer>(
        this ValueTask<IContractedConnection> connectionTask,
        TConsumer consumer,
        string? channel = null,
        string? group = null,
    ...
    /// <param name="cancellationToken">A cancellation token</param>
    /// <returns>The Contract Connection instance to allow chaining calls</returns>
    public static async ValueTask<IContractedConnection> RegisterPubSubAsyncConsumerAsync(
        this ValueTask<IContractedConnection> connectionTask,
        Type consumerType,
        string? channel = null,
        string? group = null,
    ...
    /// <param name="cancellationToken">A cancellation token</param>
    /// <returns>The Contract Connection instance to allow chaining calls</returns>
    public static async ValueTask<IContractedConnection> RegisterQueryResponseConsumerAsync<TQuery, TQueryResponse, TConsumer>(
        this ValueTask<IContractedConnection> connectionTask,
        TConsumer consumer,
        string? channel = null,
        string? group = null,
    ...
    /// <param name="cancellationToken">A cancellation token</param>
    /// <returns>The Contract Connection instance to allow chaining calls</returns>
    public static async ValueTask<IContractedConnection> RegisterQueryResponseConsumerAsync(
        this ValueTask<IContractedConnection> connectionTask,
        Type consumerType,
        string? channel = null,
        string? group = null,
    ...
    /// <param name="cancellationToken">A cancellation token</param>
    /// <returns>The Contract Connection instance to allow chaining calls</returns>
    public static async ValueTask<IContractedConnection> RegisterQueryResponseAsyncConsumerAsync<TQuery, TQueryResponse, TConsumer>(
        this ValueTask<IContractedConnection> connectionTask,
        TConsumer consumer,
        string? channel = null,
        string? group = null,
    ...
    /// <param name="cancellationToken">A cancellation token</param>
    /// <returns>The Contract Connection instance to allow chaining calls</returns>
    public static async ValueTask<IContractedConnection> RegisterQueryResponseAsyncConsumerAsync(
        this ValueTask<IContractedConnection> connectionTask,
        Type consumerType,
        string? channel = null,
        string? group = null,
    ...
    public static async ValueTask<IContractedConnection> RegisterMessageContextAsync(
        this ValueTask<IContractedConnection> connectionTask,
    ...
    /// <param name="connectionTask">Original Connection task</param>
    /// <returns>The Contract Connection instance to allow chaining calls</returns>
    public static async ValueTask<IContractedConnection> RegisterMiddlewareAsync<TMiddleware>(
        this ValueTask<IContractedConnection> connectionTask
    )
    ...
    /// <returns>The Contract Connection instance to allow chaining calls</returns>
    public static async ValueTask<IContractedConnection> RegisterMiddlewareAsync(
        this ValueTask<IContractedConnection> connectionTask, 
        Type middleware
    )
    {
    ...
    /// <returns>The Contract Connection instance to allow chaining calls</returns>
    public static async ValueTask<IContractedConnection> RegisterMiddlewareAsync<TMessage>(
        this ValueTask<IContractedConnection> connectionTask,
    ...
    /// <param name="connectionTask">Original Connection task</param>
    /// <returns>The Contract Connection instance to allow chaining calls</returns>
    public static async ValueTask<IContractedConnection> RegisterMiddlewareAsync<TMiddleware, TMessage>(
        this ValueTask<IContractedConnection> connectionTask
    )
